...
3. Secciones numeradas (`## 1. Concepto`, `## 2. Concepto`) — cada una con bloques de código inline usando paths reales del proyecto (`projects/ticket-system/src/ticket/...`).
...
- Los imports y paths en código deben reflejar la estructura real: `projects/ticket-system/src/ticket/`, `projects/ticket-system/src/core/settings.py`.
